/**
 * Http helper module. Contains the http method for making api calls. Returns a promise. Adapted from MDN: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise#Example_using_new_XMLHttpRequest()
 * @module 'http.1.0.0'
 * @author ephipps
 * @version 1.0.0
 */
		...
		var promise = new Promise(function (resolve, reject) {
			...
			client.onload = function () {
				...
				if (this.status === 200) {
					...
					reject(rejectObject(this, JSON.parse(this.response)));
				}
			};

			client.onerror = function () {
				reject(rejectObject(JSON.parse(this.response)));
			};

		});

		function rejectObject(http, response) {
			return {
